...
#
# Created: Wed Apr 29 15:20:01 2020
...
"}")
        ...
        self.keyA0 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA0.sizePolicy().hasHeightForWidth())
        self.keyA0.setSizePolicy(sizePolicy)
        self.keyA0.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA0.setMaxLength(2)
        self.keyA0.setObjectName("keyA0")
        self.horizontalLayout_5.addWidget(self.keyA0)
        self.keyA1 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA1.sizePolicy().hasHeightForWidth())
        self.keyA1.setSizePolicy(sizePolicy)
        self.keyA1.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA1.setMaxLength(2)
        self.keyA1.setObjectName("keyA1")
        self.horizontalLayout_5.addWidget(self.keyA1)
        self.keyA2 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA2.sizePolicy().hasHeightForWidth())
        self.keyA2.setSizePolicy(sizePolicy)
        self.keyA2.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA2.setMaxLength(2)
        self.keyA2.setObjectName("keyA2")
        self.horizontalLayout_5.addWidget(self.keyA2)
        self.keyA3 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA3.sizePolicy().hasHeightForWidth())
        self.keyA3.setSizePolicy(sizePolicy)
        self.keyA3.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA3.setMaxLength(2)
        self.keyA3.setObjectName("keyA3")
        self.horizontalLayout_5.addWidget(self.keyA3)
        self.keyA4 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA4.sizePolicy().hasHeightForWidth())
        self.keyA4.setSizePolicy(sizePolicy)
        self.keyA4.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA4.setMaxLength(2)
        self.keyA4.setObjectName("keyA4")
        self.horizontalLayout_5.addWidget(self.keyA4)
        self.keyA5 = QtWidgets.QLineEdit(self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyA5.sizePolicy().hasHeightForWidth())
        self.keyA5.setSizePolicy(sizePolicy)
        self.keyA5.setMaximumSize(QtCore.QSize(30, 30))
        self.keyA5.setMaxLength(2)
        self.keyA5.setObjectName("keyA5")
        self.horizontalLayout_5.addWidget(self.keyA5)
        ...
        self.keyB0 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB0.sizePolicy().hasHeightForWidth())
        self.keyB0.setSizePolicy(sizePolicy)
        self.keyB0.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB0.setMaxLength(2)
        self.keyB0.setObjectName("keyB0")
        self.horizontalLayout_7.addWidget(self.keyB0)
        self.keyB1 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB1.sizePolicy().hasHeightForWidth())
        self.keyB1.setSizePolicy(sizePolicy)
        self.keyB1.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB1.setMaxLength(2)
        self.keyB1.setObjectName("keyB1")
        self.horizontalLayout_7.addWidget(self.keyB1)
        self.keyB2 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB2.sizePolicy().hasHeightForWidth())
        self.keyB2.setSizePolicy(sizePolicy)
        self.keyB2.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB2.setMaxLength(2)
        self.keyB2.setObjectName("keyB2")
        self.horizontalLayout_7.addWidget(self.keyB2)
        self.keyB3 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB3.sizePolicy().hasHeightForWidth())
        self.keyB3.setSizePolicy(sizePolicy)
        self.keyB3.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB3.setMaxLength(2)
        self.keyB3.setObjectName("keyB3")
        self.horizontalLayout_7.addWidget(self.keyB3)
        self.keyB4 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB4.sizePolicy().hasHeightForWidth())
        self.keyB4.setSizePolicy(sizePolicy)
        self.keyB4.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB4.setMaxLength(2)
        self.keyB4.setObjectName("keyB4")
        self.horizontalLayout_7.addWidget(self.keyB4)
        self.keyB5 = QtWidgets.QLineEdit(self.frame_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyB5.sizePolicy().hasHeightForWidth())
        self.keyB5.setSizePolicy(sizePolicy)
        self.keyB5.setMaximumSize(QtCore.QSize(30, 30))
        self.keyB5.setMaxLength(2)
        self.keyB5.setObjectName("keyB5")
        self.horizontalLayout_7.addWidget(self.keyB5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.keyA0.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyA1.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyA2.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyA3.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyA4.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyA5.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        ...
        self.keyB0.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyB1.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyB2.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyB3.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyB4.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
        self.keyB5.setText(QtWidgets.QApplication.translate("MainWindow", "FF", None, -1))
